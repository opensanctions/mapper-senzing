...
process-default: data/default.json
	python ftm_processor.py OPENSANCTIONS data/default.json data/exports/default.json

process-sanctions: data/sanctions.json
	python ftm_processor.py OPENSANCTIONS data/sanctions.json data/exports/sanctions.json
